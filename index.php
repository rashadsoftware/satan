...
<?php
    $all_elan_listVIP=mysqli_query($connect, "SELECT *  FROM elan WHERE elan_raiting='vip' AND elan_status='active' ORDER BY elan_time DESC  LIMIT 20");
...
<?php
    $prem_elan_list=mysqli_query($connect, "SELECT *  FROM elan WHERE elan_raiting='premium' AND elan_status='active' ORDER BY elan_time DESC LIMIT 20 ");
