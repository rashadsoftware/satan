<?php
	if(isset($_POST)){
		...
		$inputOldPassword=mysqli_real_escape_string($connect, trim($_POST["current_password"]));
		$inputNewPassword=mysqli_real_escape_string($connect, trim($_POST["new_password"]));
		$inputConfirmPassword=mysqli_real_escape_string($connect, trim($_POST["confirm_password"]));
							...
							if($inputNewPassword==$user_password){
								...
								if($inputNewPassword==$inputConfirmPassword){
									...
									if($updatePasswordSettings){
										...
										$data["ok"]="ok";
										$data["text"]="Təbriklər! Şifrə başarılı şəkildə dəyişdirildi.";
